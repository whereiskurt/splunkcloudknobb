...
// UITemplate holds the registered Templates that can be registered by name.
...
func NewTemplate() *UITemplate {
	tt := new(UITemplate)
	return tt
}

// RegisterHelpFile registers templates under the internal/app/cmd/* folders
func (t *UITemplate) RegisterHelpFile(filename string) (err error) {
	t.HelpFilename = append(t.HelpFilename, filename)
	return
}

// RegisterPackageFile register templates under the pkg/* folders
func (t *UITemplate) RegisterPackageFile(filename string) (err error) {
...
func (t *UITemplate) RenderHelp(name string, data interface{}) (usage string) {
...
func (t *UITemplate) RenderPackage(name string, data interface{}) (usage string) {
